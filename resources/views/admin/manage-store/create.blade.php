...
@endsection
<br>
<form action="{{route('manage-store.store')}}" method="post"  id="addFrenchise">
  @csrf
        ...
        <div class="form-group-inner">
         ...
         <div class="form-group-inner">
           <div class="row">
             ...
             <div class="col-lg-3 col-md-3 col-sm-3">
              <a href="{{route('manage-store.index')}}"> <button type="button" class="btn">Cancel</button> </a>
             </div>
             <div class="col-lg-5 col-md-5 col-sm-5">
               <button type="submit" class="btn btn-primary" id="add_frenchise" >Add Store</button>
             </div>
            </div>
          </div>
      </div>
