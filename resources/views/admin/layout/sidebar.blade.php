...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="{{route('dashboard')}}"><img class="main-logo" width="200px" height="200px" src="{{asset('images/logo.png')}}" alt="" /></a>
            <strong><a href="{{route('dashboard')}}"><img src="{{asset('images/logo.png')}}" alt="" /></a></strong>
        </div>
